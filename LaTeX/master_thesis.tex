...
The number of distinct types of intelligence is an open question with multiple conflicting existing theories:
\begin{itemize}

\end{itemize}
\subsection{A suggestion }
Alongside existing theories, this thesis proposes a model of intell
...
Unlike intelligence, consciousness is not easily defined and is a subject TODO
