...
Knowing what goal to pursue is a step up, and some level of intelligence may be required to determine the location and/or nature of the end goal in a given environment.

Depending on the environment, this step may be further divided into immediate end goal knowledge and final end goal knowledge.
...
First principles knowledge consists of fundamental axioms all knowledge relies upon.
This is the highest level of knowledge, and an artificial agent capable of inferring this knowledge from observation alone without prior learning would, without doubt, be a form of artificial superintelligence and rival not only individual humans, but humanity as a whole.
TODO
\end{itemize}
