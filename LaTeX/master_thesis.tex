...
the best recommendation this thesis can give is to work on making safe AI easier to implement, but also invest a significant amount of resources in safe AGI research in order to develop the first AGI without compromising on safety.
