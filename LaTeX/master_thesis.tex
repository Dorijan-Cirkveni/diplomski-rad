...
It builds upon biological models of neural systems from the 1970s and Alan Turing's morphogenesis models from the 1950s, and while not explicitly stated as such, it can be considered a precursor to future embodied cognition projects such as
\subsubsection{COG}
