...
(that is, to ensure the agents can interact with the environment without crashing) before the agents are subjected to more complex and resource-consuming test environments.
