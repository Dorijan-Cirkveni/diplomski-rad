...
Image generation AI, on the other hand, managed to reach widespread use thanks to its capability of generating images based on natural language prompts, utilising and expanding upon the aforementioned ability to recognise natural language input.
\begin{figure}[htb]
  \centering
...
\begin{itemize}
\item This tendency makes correctly identifying sentience - and, more frequently, lack thereof - in artificial intelligence agents significantly more difficult as it introduces 
\end{itemize}
...
It is common to see AI characters depicted in media in form of conscious AGI (Artificial General Intelligence) characters with thought processes and actions similar to their human counterparts.
...
This test has the advantage of being easily implemented into testing environments used to evaluate the performance of artificial intelligence agents.
...
\subsection{Test-driven environment design}
...
In mirror test environments, test entities
